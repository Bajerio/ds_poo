...
const pSex = document.querySelector(".panel_sexo")
const btn_sex_men = document.querySelector("#sub_btn_hombre")
const btn_mujer = document.querySelector("#sub_btn_mujer")


const parra = document.querySelector("#parrafo")
...
function elegir_clase(){
    ...
    divElement.appendChild(inputMen)
        ...
        btn_clase.addEventListener("click", function(e){
            ...
            // if(e.target && e.target.id == 'sub_btn_hombre'){
            //     console.log("Entra en prueba_btn")
            // }
